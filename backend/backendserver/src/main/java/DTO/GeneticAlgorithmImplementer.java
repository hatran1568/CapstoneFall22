...
public class GeneticAlgorithmImplementer {
    ...
    public GeneticAlgorithmImplementer(AlgorithmData data) {
        this.data = data;
    }
    ...
    // Driver code
    public Solution generatePopulation(AlgorithmData data)  {
    ...
    public Solution crossover(Solution parent1, Solution parent2, AlgorithmData data)  {
    ...
    public Solution mutation(Solution s, AlgorithmData data) {
    ...
    public Solution mutation2(Solution s, AlgorithmData data){
        Solution newS = new Solution(data);

        return generatePopulation(data);
    }

    public Solution implementGA(AlgorithmData data){
