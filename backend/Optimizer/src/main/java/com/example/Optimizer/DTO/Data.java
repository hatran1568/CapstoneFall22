...
public class Data {
    ...
    public Data(Date _startDate, Date _endDate, double _distanceOfPOI[][], POI[] _POIs, int _numberOfPOI, int[] _userPreference, int _budget, int _start, int _end,int _userId){
        ...
        this.dayOfTrip  = (int) TimeUnit.DAYS.convert(diff/(24*3600*1000), TimeUnit.DAYS)+1;
