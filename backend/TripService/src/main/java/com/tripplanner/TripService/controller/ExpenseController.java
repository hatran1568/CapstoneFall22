...
public class ExpenseController {
  ...
  public ResponseEntity<ArrayList<TripExpenseDTO>> getExpenseByTrip(
  ...
  public ResponseEntity<ArrayList<ExpenseGraphDTO>> getExpenseGraphData(
    @PathVariable int tripId
  ) {
    try {
  ...
  public ResponseEntity<?> addCustomTripDetail(
