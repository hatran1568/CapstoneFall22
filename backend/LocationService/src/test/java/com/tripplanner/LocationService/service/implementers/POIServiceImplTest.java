...
class POIServiceImplTest {
  ...
  void updateRatingInPOITest() {
    ...
    verify(poiRepo, times(1)).updateRatingInPOI(4, "", date, 1, 1);
  }
  ...
  void createRatingInPOITest() {
    ...
    verify(poiRepo, times(1)).createRatingInPOI("", date, date, 4, 1, 1);
  }
  ...
  class GetHotelsByDestinationTest {
    ...
    void testing(HotelsRequestDTO input, Optional<String> thumbnailOptional) {
      ...
      ArrayList<SearchPOIAndDestinationDTO> returnedList = service.getHotelsByDestination(
        input
      );
