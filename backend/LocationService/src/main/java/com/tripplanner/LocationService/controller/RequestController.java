...
import com.tripplanner.LocationService.dto.request.NewRequestDTO;
import com.tripplanner.LocationService.dto.response.RequestDetailsDTO;
import com.tripplanner.LocationService.dto.response.RequestListDTO;
import com.tripplanner.LocationService.repository.RequestRepository;
...
public class RequestController {
  ...
  public ResponseEntity<ArrayList<RequestListDTO>> getReqListAdmin(
  ...
  public ResponseEntity<Integer> getReqListAdminCount(
    @PathVariable("nameKey") String nameKey
  ) {
    try {
      int count;
  ...
  public ResponseEntity<RequestDetailsDTO> getReqDetails(
    @PathVariable("reqId") int reqId
  ) {
    try {
