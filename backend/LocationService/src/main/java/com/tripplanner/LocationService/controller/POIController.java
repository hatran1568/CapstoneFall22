...
public class POIController {
  ...
  public ResponseEntity<POIDTO> getPOIDTODetails(
    @PathVariable("poiId") int poiId
  ) {
    try {
      POI poi;
  ...
  public ResponseEntity<MasterActivityDTO> getMasterActivityDTO(
    @PathVariable int id
  ) {
    return new ResponseEntity<>(
      poiService.getMasterActivity(id),
      HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<?> addTripDetailGenerated(
    @RequestBody TripDetailDTO input
  ) {
    try {
  ...
  public ResponseEntity<ArrayList<RatingDTO>> updateRating(
    ...
    try {
      ...
      ArrayList<RatingDTO> list = poiService.getRatingListByPOIId(
        poiId,
  ...
  public ResponseEntity<?> cloneCustom(@PathVariable int id) {
    return new ResponseEntity<>(
      poiService.cloneCustomActivity(id),
      HttpStatus.OK
    );
  }
