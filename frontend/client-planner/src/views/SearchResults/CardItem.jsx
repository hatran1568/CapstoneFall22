...
function CardItem(props) {
    ...
    return <a href={props.item.type=="DESTINATION"?("Destination?id="+props.item.id):(props.item.type=="BLOG"?("Blog?id="+props.item.id):("poi?id="+props.item.id))} className={style.link}><MDBCard  className={style.item}>
