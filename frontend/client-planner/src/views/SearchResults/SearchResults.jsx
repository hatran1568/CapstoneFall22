...
function SearchResults(props){
    ...
    const getResult = ()=>{
        ...
        }).then((response) => response.data).catch(()=> setResult(false)).then((data)=>{setResult(data.list);setTotalPage(data.totalPage)});
   ...
   return <MDBContainer >
        <MDBRow>
            ...
            <MDBCol size="8">
                ...
                {result && <ReactPaginate className={style.pagination +" pagination"}
        nextLabel=">"
