      ...
      if (index % 2 == 0)
        poiTableData.push(
          <tr className={style.tableDataGrey}>
            <th scope='col'>{entry.activityId}</th>
            ...
            <th scope='col' className={style.tableRate}>{entry.rating}<FontAwesomeIcon className={style.star} icon={faStar}/></th>
        ...
        poiTableData.push(
          <tr className={style.tableData}>
            <th scope='col' className={style.tableId}>{entry.activityId}</th>
            <th scope='col'><a className={style.tableNameData}  href={"../poi?id=" + entry.activityId}>{name}</a></th>
            <th scope='col' className={style.tableDate}>{dateCreated}</th>
            <th scope='col' className={style.tableDate}>{dateModified}</th>
            <th scope='col' className={style.tableRate}>{entry.rating}<FontAwesomeIcon className={style.star} icon={faStar}/></th>
