...
class DestinationList extends Component {
  ...
  deleteDes = async (event) => {
    ...
    confirm({
      ...
      onOk: async () => {
        await axios.post(
          `http://localhost:8080/location/api/destination/delete/` + poiId,
          {
            headers: {
          ...
          <tr className={style.tableDataGrey}>
            ...
            <th scope="col">
              <a
                ...
                href={"../destination?id=" + entry.desId}
              >
                {name}
              </a>
            </th>
            ...
            <th scope="col" className={style.tableBelongData}>
              {entry.belongTo}
            </th>
            <th scope="col" className={style.tablePOI}>
              {entry.pois}
            </th>
            <th scope="col" className={style.tableActions}>
              <a
                className={style.tableIcons}
                href={"./update?id=" + entry.desId}
              >
