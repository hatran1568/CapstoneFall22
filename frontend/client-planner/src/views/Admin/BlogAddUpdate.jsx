...
class BlogAddUpdate extends Component {
  ...
  componentDidMount() {
    ...
    setInterval(() => {
      if (
        document.getElementById("blogTitleInput").value != null &&
        ...
        axios({
          method: "post",
          url: "http://localhost:8080/blog/api/blog/update",
          data: {
            blogId: id,
            content: htmlPuri,
            status: "DRAFT",
    ...
    if (this.state.dataLoaded) {
      ...
      const contentBlock =
        typeof window !== "undefined"
          ? htmlToDraft(this.state.blog.content)
          : null;
      if (contentBlock) {
      ...
      document.getElementById("blogTitleInput").style.height =
        document.getElementById("blogTitleInput").scrollHeight + "px";
    }
    return (
      <MDBContainer className={style.mainContainer}>
        <div className={style.nav}>
          <a className={style.navItem} href="./list">
            <b>Quản lí blog</b>
          </a>
