...
class Dashboard extends Component {
  ...
  async componentDidMount() {
    ...
    axios
      .get("http://localhost:8080/blog/api/admin/ratingCount", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((res) => {
        const data = res.data;
    ...
    axios
      .get(
        "http://localhost:8080/blog/api/admin/counttrip/" +
          yesterday +
          "/" +
          today,
        {
    ...
    axios
      .get("http://localhost:8080/blog/api/admin/toppoi", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((res) => {
        const data = res.data;
    ...
    axios
      .get("http://localhost:8080/blog/api/admin/hotelcount", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((res) => {
        const data = res.data;
    ...
    axios
      .get("http://localhost:8080/blog/api/admin/poicount", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((res) => {
        const data = res.data;
    ...
    axios
      .get("http://localhost:8080/blog/api/admin/toprating", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((res) => {
        const data = res.data;
    ...
    axios
      .get("http://localhost:8080/blog/api/admin/topcountrating", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((res) => {
        const data = res.data;
    ...
    await axios
      .get(
        "http://localhost:8080/blog/api/admin/countuser/" +
          yesterday +
          "/" +
          today,
        {
  ...
  render() {
    ...
    if (this.state.dataLoaded) {
      ...
      topRatingBox.push(
        <MDBRow className={style.ratingBox}>
          <MDBCol className={style.ratingBoxItem}>
            {this.state.topRating[0].name}
            <br />
            <FontAwesomeIcon className={style.ratingStar} icon={faStar} />
            <b>
              {this.state.topRating[0].rating}
              <br />
              {this.state.topRating[0].count} đánh giá
            </b>
          </MDBCol>
          <MDBCol className={style.ratingBoxItem}>
            {this.state.topRating[1].name}
            <br />
            <FontAwesomeIcon className={style.ratingStar} icon={faStar} />
            <b>
              {this.state.topRating[1].rating}
              <br />
              {this.state.topRating[1].count} đánh giá
            </b>
          </MDBCol>
          <MDBCol className={style.ratingBoxItem}>
            {this.state.topRating[2].name}
            <br />
            <FontAwesomeIcon className={style.ratingStar} icon={faStar} />
            <b>
              {this.state.topRating[2].rating}
              <br />
              {this.state.topRating[2].count} đánh giá
            </b>
          </MDBCol>
          <br />
        </MDBRow>
      ...
      topCountRatingBox.push(
        <MDBRow className={style.ratingBox}>
          <MDBCol className={style.ratingBoxItem}>
            {this.state.topCountRating[0].name}
            <br />
            <FontAwesomeIcon className={style.ratingStar} icon={faStar} />
            <b>
              {this.state.topCountRating[0].rating}
              <br />
              {this.state.topCountRating[0].count} đánh giá
            </b>
          </MDBCol>
          <MDBCol className={style.ratingBoxItem}>
            {this.state.topCountRating[1].name}
            <br />
            <FontAwesomeIcon className={style.ratingStar} icon={faStar} />
            <b>
              {this.state.topCountRating[1].rating}
              <br />
              {this.state.topCountRating[1].count} đánh giá
            </b>
          </MDBCol>
          <MDBCol className={style.ratingBoxItem}>
            {this.state.topCountRating[2].name}
            <br />
            <FontAwesomeIcon className={style.ratingStar} icon={faStar} />
            <b>
              {this.state.topCountRating[2].rating}
              <br />
              {this.state.topCountRating[2].count} đánh giá
            </b>
          </MDBCol>
          <br />
        </MDBRow>
      ...
      this.state.topPOIs.forEach((entry, index) => {
        ...
        topPOIBox.push(
          <MDBCol className={style.poiBoxItem}>
            <img className={style.poiImage} src={imgLink} />
            <br />
            <b>{entry.name}</b>
            <br />
            Xuất hiện{" "}
    ...
    return (
      <MDBContainer className={style.bodyContainer}>
        <MDBCard className={style.allCountBox}>
          ...
          <MDBRow>
            <MDBCol className={style.countItem}>
              ...
              <br />
              <span className={style.countItemText1}>
                {this.state.countAll.users}
              </span>
            ...
            <MDBCol className={style.countItem}>
              ...
              <br />
              <span className={style.countItemText2}>
                {this.state.countAll.pois}
              </span>
              <span> Địa điểm</span>
            </MDBCol>
            <MDBCol className={style.countItem}>
              ...
              <br />
              <span className={style.countItemText3}>
                {this.state.countAll.destinations}
              </span>
              <span> Điểm đến</span>
            </MDBCol>
            <MDBCol className={style.countItem}>
              ...
              <br />
              <span className={style.countItemText4}>
                {this.state.countAll.trips}
              </span>
              <span> Chuyến đi</span>
            </MDBCol>
            <MDBCol className={style.countItem}>
              <span className={style.countItemIconBox5}>
                <FontAwesomeIcon
                  icon={faPenToSquare}
                  className={style.countItemIcon}
                />
              ...
              <br />
              <span className={style.countItemText5}>
                {this.state.countAll.requests}
              </span>
              <span> Yêu cầu</span>
            </MDBCol>
            <MDBCol className={style.countItem}>
              <span className={style.countItemIconBox6}>
                <FontAwesomeIcon
                  icon={faBook}
                  className={style.countItemIcon}
                />
              ...
              <br />
              <span className={style.countItemText6}>
                {this.state.countAll.blogs}
              </span>
              <span> Bài blog</span>
            </MDBCol>
          </MDBRow>
        ...
        <MDBCard className={style.allCountBox}>
          <h4>
            <b>Các địa điểm nổi tiếng nhất</b>
          </h4>
          <MDBRow>{topPOIBox}</MDBRow>
        </MDBCard>
        <MDBRow>
          <MDBCol>
            ...
            <MDBCard className={style.byDateBox}>
              <MDBCardBody className={style.allCountBox}>
                ...
                <MDBRow>
                  <MDBCol>
                    <span className={style.countItemIconBox7}>
                      <FontAwesomeIcon
                        icon={faPlaceOfWorship}
                        className={style.countItemIcon}
                      />
                    ...
                    <br />
                    <span className={style.countItemText7}>
                      {this.state.poiCount}
                    </span>
                    <span> Địa điểm</span>
                  </MDBCol>
                  <MDBCol>
                    <span className={style.countItemIconBox8}>
                      <FontAwesomeIcon
                        icon={faHotel}
                        className={style.countItemIcon}
                      />
                    ...
                    <br />
                    <span className={style.countItemText8}>
